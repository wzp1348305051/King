...
public class L {
     ...
     * @param object 消息体, 支持STRING, MAP, SET, LIST, ARRAY
     */
    public static void dTag(@Nullable String tag, @Nullable Object object) {
        log(DEBUG, tag, toString(object));
    }
     ...
     * @param args    消息体中占位符代表的参数
     */
    public static void dTag(@Nullable String tag, @Nullable String message, @Nullable Object... args) {
        log(DEBUG, tag, createMessage(message, args));
    }
    ...
    public static void eTag(@Nullable String tag, @NonNull Throwable throwable) {
     ...
     * @param args    消息体中占位符代表的参数
     */
    public static void eTag(@Nullable String tag, @Nullable String message, @Nullable Object... args) {
     ...
     * @param args    消息体中占位符代表的参数
     */
    public static void eTag(@Nullable String tag, @Nullable Throwable throwable, @Nullable String message,
     ...
     * @param args    消息体中占位符代表的参数
     */
    public static void iTag(@Nullable String tag, @Nullable String message, @Nullable Object... args) {
     ...
     * @param args    消息体中占位符代表的参数
     */
    public static void vTag(@Nullable String tag, @Nullable String message, @Nullable Object... args) {
     ...
     * @param args    消息体中占位符代表的参数
     */
    public static void wTag(@Nullable String tag, @Nullable String message, @Nullable Object... args) {
     ...
     * @param args    消息体中占位符代表的参数
     */
    public static void wtfTag(@Nullable String tag, @Nullable String message, @Nullable Object... args) {
    ...
    public static void jsonTag(@Nullable String tag, @Nullable String json) {
        log(DEBUG, tag, toJsonString(json));
    }
    ...
    public static void xmlTag(@Nullable String tag, @Nullable String xml) {
        log(DEBUG, tag, toXmlString(xml));
    }

    @NonNull
    public static String createMessage(@Nullable String message, @Nullable Object... args) {
        if (message == null) {
    ...
    @NonNull
    public static String toJsonString(@Nullable String json) {
        if (json == null) {
            return EmptyConstant.EMPTY_STRING;
        }
    ...
    @NonNull
    public static String toXmlString(@Nullable String xml) {
        if (xml == null) {
            return EmptyConstant.EMPTY_STRING;
        }
